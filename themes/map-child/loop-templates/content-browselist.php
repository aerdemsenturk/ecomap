...
<div class="d-flex no-gutters">
    ...
    <div class="scroll-area col-12 col-lg-6 col-md-6 col-sm-6 col-xs-6" id="toggle">
        ...
        <!-- Mobile version -->
        <div class="col-12 pt-3 pb-3 border-left d-block d-sm-none">
            <button type="button" class="btn btn-sm btn-primary float-left" data-toggle="modal" data-target="#ModalFilters" id="togglefilter">FILTER</button>
            <button type="button" class="btn btn-sm btn-primary float-right" id="toggleclose" onclick="togglecontent()">MAP</button>
        </div>
        ...
        <div class="card-block border-left" id="accordion">
            ...
            <?php endwhile; else : ?>
                <div class="col-12 p-3">
                    ...
                    <button type="button" class="btn btn-outline-primary btn-sm pt-3" onclick="FWP.reset()">Clear</button>
                </div>  
            <?php endif; ?>
